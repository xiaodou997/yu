...
pub struct GanttCalendar {
    ...
    pub weekdays: [bool; 7],
    pub excluded: std::collections::BTreeSet<i32>,
    pub included: std::collections::BTreeSet<i32>,
}
...
pub struct Graph {
    ...
    pub sequence_created: HashMap<String, usize>,
    pub sequence_destroyed: HashMap<String, usize>,
    ...
    pub gantt_schedule: Vec<(f64, f64)>,
    pub gantt_render_ends: Vec<f64>,
    pub gantt_calendar: GanttCalendar,
    pub gantt_reference_day: Option<i32>,
    pub gantt_today_marker: Option<GanttTodayMarker>,
...
impl Graph {
    pub fn new() -> Self {
        Self {
            ...
            sequence_created: HashMap::new(),
            sequence_destroyed: HashMap::new(),
            ...
            gantt_tasks: Vec::new(),
            gantt_schedule: Vec::new(),
            gantt_render_ends: Vec::new(),
            gantt_calendar: GanttCalendar::default(),
            gantt_reference_day: None,
            gantt_today_marker: Some(GanttTodayMarker::default()),
            gantt_title: None,
...
/// Exact hundredths for sequence labels; avoids floating point accumulation.
